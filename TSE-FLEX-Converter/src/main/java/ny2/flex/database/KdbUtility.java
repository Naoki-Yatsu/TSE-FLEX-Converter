...
public class KdbUtility {
    ...
    /**
     * Convert DateTime(QJava) to LocalDateTime
    ...
    public static LocalDateTime convertToLocalDateTime(DateTime dateTime) {
        if (dateTime instanceof QDateTime) {
            ...
            throw new RuntimeException(dateTime.getClass().getSimpleName() + " cannot be converted to LocalDateTime.");
        }
    }

    /**
     * Convert Kdb-QDateTime to LocalDateTime
     * @param qDateTime
     * @return
     */
    ...
    /**
     * Convert Kdb-QTimestamp to LocalDateTime
     * @param qTimestamp
     * @return
     */
    ...
    /**
     * Convert Kdb-QDate to LocalDate
     * @param qDate
     * @return
     */
    ...
    /**
     * Convert Kdb-QTime to LocalTime
     * @param qTime
     * @return
     */
    ...
    /**
     * Convert Kdb-QTimespan to LocalTime
     * @param qTimespan
     * @return
     */
